...
public class HomeActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_nav_menu);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        // Retrieve the QR Code Scanning Result
        ...
        if(intentResult.getContents()!=null){
            ...
            // If the QR code content consist more than or less than 2 parts, it is corrupted and invalid,
            // else proceeds to the checking of timestamp
            if(arrOfDecodedInformation.length == 2){
                ...
                // QR Code expire in 30 seconds
                // Compare the timestamp on the QR code with the current time
                // If the time difference is within 30 secs, proceeds the payment process, else alert the users that the QR code has expired
